...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Messages d'erreur par défaut du validateur. Traduction FR reprenant les
    | mêmes clés que le validation.php anglais de Laravel (source de vérité :
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute est apparu dans une fuite de données. Merci d\'en choisir un autre.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Messages personnalisés par attribut, convention « attribut.règle ».
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace le placeholder :attribute par un libellé lisible. Couvre les
    | champs des formulaires du projet (SessionForm, Profil, Admin/*).
    |
    */
    ...
    'attributes' => [
        ...
        'duration_min' => 'durée',
        'location_id' => 'lieu',
        'location_text' => 'lieu libre',
        'capacity' => 'capacité',
        'event_type_id' => "type d'épreuve",
        'distance' => 'distance',
        'external_url' => 'lien externe',
        'photos_album_url' => 'album photos',
        'category_ids' => 'catégories',
        'coach_ids' => 'encadrants',
        'quota_tag_id' => 'tag quota',
        'content_markdown' => 'contenu',
        'agenda' => 'agenda',
        'route_openrunner_embed_url' => "lien d'embed OpenRunner",
        'route_openrunner_public_url' => 'lien public OpenRunner',
        'gpxFile' => 'fichier GPX',

        // Champs communs (Profil, Admin/*, auth)
        'name' => 'nom',
        'first_name' => 'prénom',
        'last_name' => 'nom',
