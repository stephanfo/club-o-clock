...
<img src="./img/planning-semaine.png" alt="Planning hebdomadaire : séances groupées par jour, une séance annulée, une inscription en liste d'attente" width="360" height="778" loading="lazy">
...
|---|---|---|
| <img src="./img/seance-infos.png" alt="Onglet Infos d'une séance : horaires, lieu, description" width="240" height="519" loading="lazy"> | <img src="./img/seance-encadrement.png" alt="Onglet Encadrement : coach de la séance et ses qualifications" width="240" height="519" loading="lazy"> | <img src="./img/seance-parcours.png" alt="Onglet Parcours : tracé GPX sur fond OpenStreetMap avec bornes kilométriques" width="240" height="519" loading="lazy"> |
...
<img src="./img/mes-enfants.png" alt="Écran Mes enfants : Jade (phase P1, sans compte propre) et Noah (phase P2, avec son compte)" width="360" height="778" loading="lazy">
...
<img src="./img/coach-creer-seance.png" alt="Formulaire de création de séance : type, discipline, capacité, tag de quota, catégories ciblées, encadrement" width="720" height="593" loading="lazy">
...
<img src="./img/admin-dashboard.png" alt="Dashboard admin : compteurs d'adhérents, évolution des inscriptions, statistiques de liste d'attente" width="720" height="593" loading="lazy">
...
<img src="./img/admin-adherents.png" alt="Liste des adhérents : compteurs par statut, filtres, rôles cumulés, colonne parent" width="720" height="593" loading="lazy">
...
<img src="./img/admin-generation.png" alt="Modèles de séance : liste des modèles actifs et formulaire de génération sur une plage de dates" width="720" height="593" loading="lazy">
...
<img src="./img/admin-envois.png" alt="File des notifications : une ligne par destinataire et par canal, statut et nombre de tentatives" width="720" height="593" loading="lazy">
...
<img src="./img/admin-journaux.png" alt="Journaux : date, acteur, action et cible, filtrables par type, acteur, action et séance" width="720" height="593" loading="lazy">
...
<img src="./img/admin-pages-info.png" alt="Pages d'information : quatre pages actives, chacune avec sa portée de visibilité et ses actions" width="720" height="593" loading="lazy">
...
<img src="./img/admin-parametres.png" alt="Paramètres : identité du club (nom, logo, baseline, palette) à gauche, mentions légales à droite" width="720" height="593" loading="lazy">
...
> 📖 Retour au [README](https://github.com/stephanfo/club-o-clock/blob/main/README.md) · Comptes et scénarios de la démo dans
